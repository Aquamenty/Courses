...
public class CardpayOtherTests {
    ...
    @Test
    public void checkMouePopup() {
        WebElement toggle = driver.findElement(By.id("cvc-hint-toggle"));
        Actions actions = new Actions(driver);
        actions.moveToElement(toggle).build().perform();

        WebElement popup = driver.findElement(By.id("cvc-hint-bubble"));
